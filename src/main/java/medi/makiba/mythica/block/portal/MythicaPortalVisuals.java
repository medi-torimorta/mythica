...
public class MythicaPortalVisuals {
	...
	public static void handlePortalVisuals(Player player) {
		if (player.level().isClientSide()) {
			...
			if (player.portalProcess != null && player.portalProcess.isSamePortal((Portal) MythicaBlocks.MYTHICA_PORTAL.get()) && player.portalProcess.isInsidePortalThisTick()) {
